...
// The port is hardcoded to 30001
...
char* decrypt_data(int key_str_size, char* key_file_str, int encrypted_data_str_size, char* encrypted_data_str);
...
void null_check(char* token, int connect_d);
